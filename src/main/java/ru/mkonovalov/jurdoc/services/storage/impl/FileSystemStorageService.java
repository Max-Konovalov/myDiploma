...
import ru.mkonovalov.jurdoc.core.configuration.StorageConfig;
import ru.mkonovalov.jurdoc.core.exceptions.NotFoundException;
import ru.mkonovalov.jurdoc.core.exceptions.StorageException;
	...
	public Resource loadAsResource(String filename) {
		try {
			...
			if (resource.exists() || resource.isReadable()) {
				...
				throw new NotFoundException(Attachment.class, filename);
